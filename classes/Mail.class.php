<?php
	...
	class Mail{
		...
		public $opt,$mailer;
		public $email = 'enviomeusite@gmail.com';//Trocar e-mail aqui!
		public $senha = 'Caio0718';//Trocar senha aqui!
		...
		public function __construct(Array $parametros){
			...
			$this->mailer->IsSMTP();
			$this->mailer->Host = 'go6.com.br'; //SERVIDOR SMTP DA HOSPEDAGEM
			...
			$this->mailer->Subject = 'Mensagem do Principal';
